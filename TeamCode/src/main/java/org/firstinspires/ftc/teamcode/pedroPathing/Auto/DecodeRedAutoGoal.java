...
public class DecodeRedAutoGoal extends OpMode {
    ...
    private final Pose startPose = new Pose(115,125, Math.toRadians(37));
    private final Pose firstshootPose = new Pose(80,84,Math.toRadians(44));
    ...
    public void statePathUpdate(){
        switch(pathState) {
            ...
            case Tourne1: // on tourne avant de rammaser les balles
                if (!follower.isBusy()){
                    follower.followPath(driveTourne1 ,0.7, false);
                    //follower.turn(Math.toRadians(-45),false);
            ...
            case align_RANGEE1Blue: // On va s'aliner avec la rangée 1
                ...
                if (!follower.isBusy()) {
                    ...
                    // transition to next state
                    follower.followPath(driveShoot2pickup1Pos ,0.7, false); // chemin d'alignement de la premiere rangée
